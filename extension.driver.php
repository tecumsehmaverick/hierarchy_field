<?php
	 ...
	 */
	class Extension_Hierarchy_Field extends Extension {
		/**
		 * The name of the field settings table.
		 */
		const FIELD_TABLE = 'tbl_fields_hierarchy';
		...
		public function appendBreadcrumbOptions($context) {
			if ($context['data']['type'] != 'hierarchy') return;
		...
		public function getFieldBySectionId($section_id) {
			...
			foreach ($fields as $field) {
				if ($field instanceof FieldHierarchy) continue;
